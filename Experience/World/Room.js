...
export default class Room {
  ...
  setLampligt() {
    ...
    const height = 0.7
    const intensity = 1
    this.rectLight = new THREE.RectAreaLight(0xd13bd1, intensity, width, height)
      ...
      this.lampControl.fromTo(
        ...
        { intensity: 0 },
        {
          ...
          ease: CustomEase.create(
            'custom',
            'M0,0,C0.054,0.164,0.064,0.552,0.064,0.552,0.064,0.552,0.128,0,0.128,0,0.128,0,0.182,0.762,0.182,0.762,0.182,0.762,0.266,0,0.266,0,0.266,0,0.358,1,0.358,1,0.358,1,0.464,0,0.464,0,0.464,0,0.56,0.724,0.56,0.724,0.56,0.724,0.636,0,0.636,0,0.636,0,0.754,0.574,0.754,0.574,0.754,0.574,0.838,0,0.838,0,0.838,0,0.958,0,0.958,0,0.958,0,0.995,1.001,1,1'
          )
        }
      )
    } else {
